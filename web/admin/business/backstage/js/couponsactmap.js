...
var api = {
	...
	del:{url:T.serverurl + "business/couponsactmap/del", type:"post"},
	delbyguids:{url:T.serverurl + "business/couponsactmap/delbyguids", type:"post"},
	page:{url:T.serverurl + "business/couponsactmap/page", type:"post"}
}
layui.use([ 'laypage', 'layer', 'table' ], function() {
	...
	$.tabfield = [
		...
		{ title: '商品guid', field: 'activityGuid', width: 180 },			
	...
	table.on('tool(default)', function(obj) { // 注：tool是工具条事件名，test是table原始容器的属性
		...
		if (layEvent === 'detail') {
			...
			location.href = "couponsactmap_form.html?guid=" + data.guid;
		}
	});
