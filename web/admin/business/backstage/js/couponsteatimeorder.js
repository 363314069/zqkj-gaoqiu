$(function(){
var api = {
	list:{url:T.serverurl + "business/couponsteatimeorder/list", type:"post"},
	info:{url:T.serverurl + "business/couponsteatimeorder/info", type:"get"},
	del:{url:T.serverurl + "business/couponsteatimeorder/del", type:"post"},
	delbyguids:{url:T.serverurl + "business/couponsteatimeorder/delbyguids", type:"post"},
	page:{url:T.serverurl + "business/couponsteatimeorder/page", type:"post"}
}
layui.use([ 'laypage', 'layer', 'table' ], function() {
	...
	table.on('tool(default)', function(obj) { // 注：tool是工具条事件名，test是table原始容器的属性
		...
		if (layEvent === 'detail') {
			...
			location.href = "couponsteatimeorder_form.html?guid=" + data.guid;
		}
	});
