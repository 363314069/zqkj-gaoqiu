...
var api = {
	...
	del:{url:T.serverurl + "security/vipcoupons/del", type:"post"},
	delbyguids:{url:T.serverurl + "security/vipcoupons/delbyguids", type:"post"},
	page:{url:T.serverurl + "security/vipcoupons/page", type:"post"}
}
layui.use([ 'laypage', 'layer', 'table' ], function() {
	...
	$.tabfield = [
		...
		{ title: '购买起期限', field: 'term', width: 180 },
		{ title: '类型（卡的类型，通过参数表管理）', field: 'type', width: 180 },			
	...
	table.on('tool(default)', function(obj) { // 注：tool是工具条事件名，test是table原始容器的属性
		...
		if (layEvent === 'detail') {
			...
			location.href = "vipcoupons_form.html?guid=" + data.guid;
		}
	});
