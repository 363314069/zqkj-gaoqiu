$(function(){
var api = {
	list:{url:T.serverurl + "business/couponsorgmap/list", type:"post"},
	info:{url:T.serverurl + "business/couponsorgmap/info", type:"get"},
	del:{url:T.serverurl + "business/couponsorgmap/del", type:"post"},
	delbyguids:{url:T.serverurl + "business/couponsorgmap/delbyguids", type:"post"},
	page:{url:T.serverurl + "business/couponsorgmap/page", type:"post"}
}
layui.use([ 'laypage', 'layer', 'table' ], function() {
	...
	$.tabfield = [
		...
		{ title: '优惠卷GUID', field: 'couponsGuid', width: 180 },			
	...
	table.on('tool(default)', function(obj) { // 注：tool是工具条事件名，test是table原始容器的属性
		...
		if (layEvent === 'detail') {
			...
			location.href = "couponsorgmap_form.html?guid=" + data.guid;
		}
	});
