$(function(){
var api = {
	list:{url:T.serverebusiness + "business/teatime/list", type:"post"},
	info:{url:T.serverebusiness + "business/teatime/info", type:"get"},
	del:{url:T.serverebusiness + "business/teatime/del", type:"post"},
	delbyguids:{url:T.serverebusiness + "business/teatime/delbyguids", type:"post"},
	page:{url:T.serverebusiness + "business/teatime/page", type:"post"}
}
layui.use([ 'laypage', 'layer', 'table' ], function() {
	...
	$.tabfield = [
		...
		{ title: '订场GUID', field: 'reservationGuid', width: 180 },			
		{ title: '场地信息', field: 'introductionGuid', width: 180 },			
		{ title: '每天日期GIUD', field: 'reservationDateGuid', width: 180 },			
		{ title: '用户GUID', field: 'userGuid', width: 180 },			
		{ title: '时间', field: 'time', width: 180 },			
		{ title: '日期', field: 'date', width: 180 },			
		{ title: '内容', field: 'content', width: 180 },			
		{ title: '图片', field: 'img', width: 180 },			
		{ title: '价格', field: 'price', width: 180 },			
	...
	table.on('tool(default)', function(obj) { // 注：tool是工具条事件名，test是table原始容器的属性
		...
		if (layEvent === 'detail') {
			...
			location.href = "teatime_form.html?guid=" + data.guid;
		}
	});
