$(function(){
var api = {
	list:{url:T.serverurl + "security/newssort/list",type:"get"},
	del:{url:T.serverurl + "security/newssort/del",type:"post"},
	info:{url:T.serverurl + "security/newssort/info",type:"get"},
	save:{url:T.serverurl + "security/newssort/save",type:"post"},
	update:{url:T.serverurl + "security/newssort/update",type:"post"}
};
