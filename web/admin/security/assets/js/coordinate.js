$(function(){
var api = {
	list:{url:T.serviceurl + "oauth/coordinate/list", type:"post"},
	info:{url:T.serviceurl + "oauth/coordinate/info", type:"get"},
	del:{url:T.serviceurl + "oauth/coordinate/del", type:"post"},
	delbyguids:{url:T.serviceurl + "oauth/coordinate/delbyguids", type:"post"},
	page:{url:T.serviceurl + "oauth/coordinate/page", type:"post"}
}
layui.use([ 'laypage', 'layer', 'table' ], function() {
	...
	$.tabfield = [
		...
		{ title: '起始经度', field: 'startLongitude', width: 180 },			
		{ title: '起始纬度', field: 'startLatitude', width: 180 },			
		{ title: '结束经度', field: 'endLongitude', width: 180 },			
		{ title: '结束纬度', field: 'endLatitude', width: 180 },			
	...
	table.on('tool(default)', function(obj) { // 注：tool是工具条事件名，test是table原始容器的属性
		...
		if (layEvent === 'detail') {
			...
			location.href = "coordinate_form.html?guid=" + data.guid;
		}
	});
