...
import com.zqkj.entity.H5SceneInfo;
import com.zqkj.bean.WxPayBean;
import com.zqkj.utils.AjaxResult;
...
public class WxPayController implements AbstractWxPayApiController {
    ...
    public String getKey() {
        return WxPayApi.getSignKey(wxPayBean.getMchId(), wxPayBean.getPartnerKey(), SignType.HMACSHA256);
    }
    ...
    public AjaxResult webPay(HttpServletRequest request, @RequestParam("total_fee") String totalFee) {
        ...
        if (openId == null) {
            openId = "oEHsgw76uxG_fp3-L0BuTAieCyGg";
        }
     ...
     * 公众号发红包
     */
    @RequestMapping(value = "/SendReadPack", method = {RequestMethod.POST, RequestMethod.GET})
    @ResponseBody
    public String SendReadPack(HttpServletRequest request, @RequestParam("openId") String openId) {
